import { BoxComponentProps, Card } from '@mantine/core'
import { useEffect, useState } from 'react'
import WavesurferPlayer from '@wavesurfer/react'
import { getSampleFileHandle, getSampleName } from '../../../utils'
import { getFileUrl } from '../../../../../utils'

type SamplesListItemProps = BoxComponentProps & {
  bankDirHandle: FileSystemDirectoryHandle
  sampleNumber: number
}

export const SamplesListItem = ({ bankDirHandle, sampleNumber }: SamplesListItemProps) => {
